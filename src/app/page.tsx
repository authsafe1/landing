              ...
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                <ul>
                  <li>
                    ...
                    login experience across web, mobile, and enterprise
                    platforms.
                  </li>
                  <li>
                    <strong>Single Sign-On (SSO):</strong> Reduce password
                    fatigue by allowing users to authenticate once and access
                  ...
                  <li>
                    <strong>Ease of Integration:</strong> Compatible with
                    popular frameworks, making implementation quick and
                    developer-friendly.
                  </li>
                  <li>
