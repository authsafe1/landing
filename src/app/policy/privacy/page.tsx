      ...
      <Box sx={{ mt: 3, display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <ul>
            <li>
              <Typography component="p" gutterBottom>
                ...
                creating an account. This also includes any personal information
                you provide while contacting us or through other voluntary
                submissions.
              </Typography>
            </li>
            <li>
              <Typography component="p">
                ...
                services and ensure that our systems are operating efficiently.
              </Typography>
            </li>
          </ul>
        </Box>
          ...
          <ul>
            ...
            <li>
              <Typography component="p">
                ...
                information to send you updates regarding our services, such as
                critical security information, service outages, or
        ...
        <Box>
          ...
          <Typography component="p">
            ...
            your data for legitimate business purposes, including to comply with
            legal obligations, resolve disputes, and enforce agreements. Data is
            stored on secure servers that comply with applicable laws.
          </Typography>
          <Typography component="p">
        ...
        <Box>
          ...
          <Typography component="p">
            AuthSafe does not sell your personal data to third parties. However,
            we may share your data with trusted partners who assist us in
            providing services. These partners are subject to contractual
            agreements that ensure they handle your data securely and in
          ...
          <ul>
            ...
            <li>
              <Typography component="p">
                ...
                we provide your personal data to you in a structured, commonly
        ...
        <Box>
          ...
          <Typography component="p">
            ...
            has provided us with personal information without parental consent,
