...
type AuthSafeProps = SvgIconProps;

const AuthSafeIcon: FC<AuthSafeProps> = ({ sx = {}, ...props }) => {
  const mergeStyles = (themeStyle: object) => ({
    ...sx,
    ...themeStyle,
  });
  ...
  return (
    <Fragment>
      <SvgIcon
        {...props}
        sx={(theme) =>
          mergeStyles(theme.applyStyles('dark', { display: 'none' }))
        }
      >
        <svg
      ...
      <SvgIcon
        {...props}
        sx={(theme) =>
          mergeStyles(theme.applyStyles('light', { display: 'none' }))
        }
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
